    ...
    <section className="bg-background-500 py-16 w-full">
      <div className="container mx-auto px-4 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="flex flex-col items-center max-w-sm p-8 rounded-lg shadow-lg transition duration-300 hover:bg-brand-500 hover:text-white">
            <div className="relative w-32 h-32 mb-6">
              ...
              />
              <div className="absolute -right-2 top-0 bg-brand-500 text-white rounded-full w-10 h-10 flex items-center justify-center text-xl font-bold border-4 border-background-500">
                1
              </div>
            </div>
