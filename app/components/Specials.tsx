    ...
    <section id="specials" className="py-16 sm:py-20 bg-background-500 w-full">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-14">
          ...
          <h3 className="text-Gray-200 font-semibold text-lg mb-2 tracking-wide"></h3>
          <h2 className="font-bold text-3xl mb-12 text-Gray-200">
            Check out our menu
          </h2>
          <p className="mt-4 text-sm sm:text-base max-w-2xl mx-auto text-Gray-200 leading-relaxed">
            Demoralized by the charms of pleasure of the moment so blinded
            except to some advantage.
          </p>
        </div>

        <div className="flex justify-center items-center gap-0 mb-12 overflow-x-auto">
          {categories.map((c, i) => (
